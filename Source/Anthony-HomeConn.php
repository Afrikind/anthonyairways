...
<head>
	<title>Anthony Airways - Flights</title>
	<meta charset="utf-8">
	...
	<link rel="stylesheet" type="text/css" href="Anthony-HomeConnCSSn.css">
</head>
				...
				if ($_POST['submit']) {
					...
					if (mysqli_query($conn, $sql)) {
						...
						while ($row = mysqli_fetch_assoc($print)) {
							...
							echo "<td><form method='GET' action='Anthony-Book.php'>
    									  <input type='hidden' name='varname' value='$var_value'>
    									  <input type='submit' value='BOOK' style='color:black'>
										  </form></td>";
							echo "<td><a href='Anthony-Book.php?varname=<?php echo $var_value ?>'>Book</a></td>";

							echo "<td>
                <form method='POST' action='Anthony-Book.php'>
                    <input type='hidden' name='flightNo' value='{$row['FlightNo']}'>
                    <input type='submit' name='book' value='BOOK' style='color:black'>
                </form>
              </td>";
