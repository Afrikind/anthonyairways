...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="Anthony-HomeCSSnew.css">
</head>
...
<body>
  ...
  <nav class="navbar navbar-inverse">
    <div class="container">
      <div class="navbar-header">
        <a href="#" class="navbar-brand"><img src="images/4b5d99c4-2f06-45be-88b2-5e4bb39f9885.png" id="logo"> Anthony AIRWAYS</a>
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-12">
        <div id="content">
          <h1 class="name">Your Experience Starts Here!</h1>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="container" id="second">
    ...
    <div class="tab-content">
      ...
      <div id="home" class="tab-pane fade in active">
        ...
        <form action="Anthony-HomeConn.php" method="POST">
      ...
      <div id="menu1" class="tab-pane fade">
        ...
        <form action="Anthony-Ticket.php" method="POST">
      ...
      <div id="menu2" class="tab-pane fade">
        ...
        <form action="Anthony-FlightStatus.php" method="POST">
  ...
  <!--Login Modal End-->
  <script type="text/javascript" src="Anthony-HomeJSnew.js"></script>
</body>
...
if (!empty($uname) && !empty($em) && !empty($passsign) && !empty($confsign) && $passsign == $confsign && $sbtn == "SUBMIT") {
  $sql = "INSERT INTO users (username, email, password) VALUES ('$uname', '$em', '$passsign')";
